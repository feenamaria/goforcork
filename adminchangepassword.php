      ...
      ?>
        ...
        <div class="row">
          <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2"></div>
            ...
            <center></center><button type="submit" class="btn logi-btn" formaction="passwordchange.php">Save Password</button>
          </center>
        </div>
         <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                        <center>
                          <a href= "adminhome.php"><button class="btn logi-btnp" id="logi-btn" name="btn-reg">
                          Cancel</a>
                            </button>
                        </center>
                    </div>
