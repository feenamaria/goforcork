        ...
        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
          <table>
            <tr>
              ...
              <th><div align="center">No: of Corks</div></th>
              <th><div align="center">Amt. (<i class="fa fa-inr"></i>) </div></th>
            </tr>
            <tr>
              <?php
                                  	include('db.php');
              ...
              <td><div align="center"><?php echo $amt ?></div></td>
            </tr>
            <?php					
				                     }
                                  	?>
      ...
      <form method="post" action="adminhome.php">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
            <center>
              <button class="btn logi-btn" id="logi-btn" type="submit" value="Submit" name="btn-reg">Previous</button>
            </center>
          </div>
          <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
            <center>
              <button class="btn logi-btnp" id="logi-btn" type="submit" value="Submit" name="btn-reg">Done</button>
            </center>
          </div>
          <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
            <center>
              <button class="btn logi-btn" id="logi-btn" type="submit" value="Submit" name="btn-reg">Next</button>
            </center>
          </div>
          <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1"></div>
        </div>
