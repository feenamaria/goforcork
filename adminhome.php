    ...
    <div class="log-content">
      ...
      <div class="row">
        ...
        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8"> <a href="addmember.php">
          <center>
            <button class="btn logi-btn" id="logi-btn" type="submit" value="Submit" name="btn-reg">Add Member</button>
          </center>
          </a> </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8"> <a href="editmember.php">
          <center>
            <button class="btn logi-btn" id="logi-btn" type="submit" value="Submit" name="btn-reg">Edit Member</button>
          </center>
          </a> </div>
        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8"></div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8"> <a href="stockdistribution.php">
          <center>
            <button class="btn logi-btn" id="logi-btn" type="submit" value="Submit" name="btn-reg">Stock Distribution</button>
          </center>
          </a> </div>
        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8"></div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8"> <a href="paymentsummary.php">
          <center>
            <button class="btn logi-btn" id="logi-btn" type="submit" value="Submit" name="btn-reg">Payment Summary</button>
          </center>
          </a> </div>
        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8"></div>
      </div>
	  ...
	  <div class="row">
        ...
        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8"> <a href="amountpayment.php">
          <center>
            <button class="btn logi-btn" id="logi-btn" type="submit" value="Submit" name="btn-reg">Amount to Pay</button>
          </center>
          </a> </div>
        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8"></div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8"> <a href="addboxes.php">
          <center>
            <button class="btn logi-btn" id="logi-btn" type="submit" value="Submit" name="btn-reg">Add Boxes</button>
          </center>
          </a> </div>
        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8"></div>
      </div>
