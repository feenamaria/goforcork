 ...
 value="<?php echo $name ?>"><?php echo $name ?></option>
        ...
        <div class="row">
          ...
          <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
            <div class="form-group">
              <div class="">
			   <input class="form-control"  id="phone-num"  type="text" name="mobilenumber"  onkeypress='return event.keyCode == 8 || event.charCode >=48 && event.charCode<=57 '  pattern="^(7|8|9)\d{9}" placeholder="enter mobilenumber"  maxlength="10"  title="Enter a valid 10 digit mobilenumber starting with 9/8/7" required/>
			  </div>
            </div>
          </div>
          <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2"></div>
...
          <br/>
        ...
        <div class="row">
          ...
          <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
            <center>
              <button class="btn logi-btn" id="logi-btn" type="submit" value="Submit" name="btn-reg" formaction="updatevalues.php">Save & Continue</button>
            </center>
          </div>
          <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
            <center>
              <button class="btn logi-btnp" id="logi-btn" type="submit" value="Submit" name="btn-reg"  formaction="adminhome.php">Back</button>
            </center>
          </div>
          <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2"></div>
        </div>
