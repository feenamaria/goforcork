      ...
      <form method="post">
        ...
        <div class="row">
          ...
          <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
            <div class="form-group">
              <div class="">
                <input class="form-control" type="text" name="mobilenumber"  onkeypress='return event.keyCode == 8 || event.charCode >=48 && event.charCode<=57 '  pattern="^(7|8|9)\d{9}" placeholder="enter mobilenumber"  maxlength="10"  title="Enter a valid 10 digit mobilenumber starting with 9/8/7"/>
              </div>
            </div>
          </div>
          <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2"></div>
...
        <br/>
        ...
        <div class="row">
          ...
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
            <center>
              <button class="btn logi-btn" id="logi-btn" type="submit" value="Submit" name="btn-reg" formaction="valuesinsert.php">Add New</button>
            </center>
          </div>
