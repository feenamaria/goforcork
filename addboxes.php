...
<head>
    ...
    we have to generate a favicon from google and has to paste it in images folder.-->
                ...
                <div class="row style5">
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                        <div class="form-group">
                            <div class="">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    <div align="center" class="style12">Unit Cork Price:(<i class="fa fa-inr"></i>)
                                    </div>
                                </div>
		...
		<span class="style5"><br/>
                ...
                <div class="row style5">
                    ...
                    <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
                        <center>
                            <button name="btn-reg" value="Submit" type="submit" class="btn  style8" id="logi-btn">Save &
                                Continue
                            </button>
                        </center>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                        <center>
                            <button name="btn-reg" value="Submit" type="submit" class="btn  style9" id="logi-btn">Done
                            </button>
                        </center>
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2"></div>
