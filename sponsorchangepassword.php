      ...
      ?>
        ...
        <div class="row">
          <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2"></div>
            ...
            <center></center><button class="btn logi-btn"  type="submit" id="logi-btnn" formaction="passwordchange.php">Save Password</button>
          </center>
        </div>
         <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                        <center>

                            <button class="btn logi-btnp" id="logi-btn" name="btn-reg"> <a href="sponsorhome.php">Cancel </a>
