<?php
        ...
        $mobno=$mobnum;
  $variable1 ="http://login.smsgatewayhub.com/api/mt/SendSMS?APIKey=HqWiioRho0qVDapv1QBTxA&senderid=GOFISH&channel=2&DCS=0&flashsms=0&number=";
          $variable2 = $variable1.$mobnum;
          $variable3 = "&text=";
          $variable4 = $variable2.$variable3;
          $variable9 ="Your%20Password%20for%20goforcork.com%20:%20";
