...
<div class="container">
    ...
    <div class="log-in" style="margin-bottom:50px;">
            ...
            <form method="post">
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                        ...
                        if ($x == $_GET['a']) {
                            ...
                            <div class="alert alert-success"><a href="#" class="close" data-dismiss="alert"
                                                                aria-label="close">&times;</a>New Password & Confirm
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                        ...
                        if ($x == $_GET['c']) {
                            ?>
                            <div class="alert alert-success"><a href="#" class="close" data-dismiss="alert"
                                                                aria-label="close">&times;</a>Old password mismatch.
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
                        <button name="btn logi-btn" value="Submit" type="submit" class="btn logi-btn"
                                formaction="passwordchange.php">Save Password
                        </button>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                        <a href="backadminsponsor.php">
                            <button class="btn logi-btnp" id="logi-btn" name="btn-reg">Cancel
                        </a>
                        </button>
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2"></div>
